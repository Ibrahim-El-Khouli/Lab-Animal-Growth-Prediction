# Lab Animal Growth Prediction (Regression)
...
> In short: a reusable template for researchers to tailor to their own experimental designs **with veterinary perspective in mind**.
